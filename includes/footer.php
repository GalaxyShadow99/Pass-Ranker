            ...
            <div class="row gy-3 align-items-sm-center">
                <div class="col-12 col-sm-6">
                    <div class="footer-logo-wrapper text-start">
                        <a href="index.php" class="text-decoration-none fw-bold fs-3 text-white">
                            PASS<span class="text-primary">RANKER</span>
                        </a>
                        <p class="text-muted small mb-0">Plateforme de suivi des résultats PBI.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
        ...
        <div class="container border-top border-dark pt-4">
            <div class="row gy-3 align-items-lg-center">
                <div class="col-12 col-lg-6 order-1 order-lg-0 text-center text-lg-start">
                    <div class="copyright-wrapper d-block mb-1 fs-7 text-light opacity-50">
                        &copy; 2026 PassRanker. Tous droits réservés.
                    </div>
                </div>
